...
public class StudentActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private RatingBranchesFragment ratingBranchesFragment = new RatingBranchesFragment();
            ...
            public void onTabSelected(TabLayout.Tab tab) {
                ...
                switch (tab.getPosition()) {
                    case 0:
                        ...
                        fragmentTransaction.replace(R.id.tab_container, profileFragment);

                        break;
                    case 1:
                        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_FULL_SENSOR);
                        fragmentTransaction.replace(R.id.tab_container, ratingBranchesFragment);
