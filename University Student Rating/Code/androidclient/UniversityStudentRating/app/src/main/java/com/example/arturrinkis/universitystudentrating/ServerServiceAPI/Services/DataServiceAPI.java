...
import com.example.arturrinkis.universitystudentrating.ServerServiceAPI.Interfaces.Services.IDataServiceAPI;
...
public class DataServiceAPI implements IDataServiceAPI {
    ...
    public DataServiceAPI(String serverURL, HttpRequestUtility httpRequestUtility, CookieManager cookieManager) {
    ...
    public boolean uploadPhotoImageFile(Bitmap bitmap, String filePath) {
        ...
        try {
            ...
            jsonObject.addProperty("filePath", filePath + ".png");
